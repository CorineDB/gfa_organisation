    ...
    <Modal :show="deleteModalPreview" @hidden="deleteModalPreview = false">
      <ModalBody class="p-0">
        ...
        <div class="px-5 pb-8 text-center">
          ...
          <button type="button" @click="deleteUser" class="btn btn-danger w-24">
            Supprimer
          </button>
        </div>
      </ModalBody>
        ...
        <form @submit.prevent="storeUser">
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input id="regular-form-1" type="email" required v-model="formData.email" class="form-control"
                placeholder="Email" />
            </div>
...
const deleteUser = function () {
  ...
  UsersService.destroy(deleteData.id).then((data) => {
    message.type = 'success'
