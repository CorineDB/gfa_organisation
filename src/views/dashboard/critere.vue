          ...
          <tr v-for="(data, index) in resultQuery" :key="index">
            ...
            <td class="flex space-x-2 items-center">
              ...
              <Tippy tag="a" href="javascript:;" class="tooltip inline-block my-2" content="cliquez pour ajouter ou voir les indicateurs">
                <span @click="voirIndicateur(index, data.id)" class="text-blue-500 cursor-pointer"
                  >  <PlusCircleIcon />
                </span>
              </Tippy>
                ...
                <DropdownMenu class="w-40">
                  <DropdownContent>
                    ...
                    <Tippy tag="a" href="javascript:;" class="tooltip inline-block my-2" content="cliquez pour ajouter ou voir les critères">
                      <span @click="voirIndicateur(index, data.id)" class="text-black cursor-pointer flex justify-start items-center"
