            ...
            <div class="mt-8 intro-x">
              <div class="space-y-4">
                ...
                <div class="">
                  ...
                  <div v-if="errors.new_password" class="mt-2 text-danger">
                    {{ getFieldErrors(errors.new_password) }}
                  </div>
                </div>
                <div class="">
                  ...
                  <div v-if="errors.new_password_confirmation" class="mt-2 text-danger">
                    {{ getFieldErrors(errors.new_password_confirmation) }}
                  </div>
                </div>
              </div>
            </div>
