<template   >
  ...
  <div class="custom-bg w-screen h-screen  flex items-center justify-center">
        ...
        <div class=" mx-auto">
          <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
              <form @submit.prevent="getMail">
                <div class="p-5 flex flex-col">
                  <label for="change-password-form-1 text-left" class="form-label">Adresse mail</label>
                  <input type="text" class="intro-x login__input form-control py-3 px-4 block" v-model="mail"
                    placeholder="Email">
    ...
    <div class="w-1/2 h-full img-side p-10 flex flex-col items-center justify-between ">
      ...
      <div>
        <svg class="w-2/3 mx-auto mb-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
          <g id="freepik--Floor--inject-4">
            <ellipse id="freepik--floor--inject-4" cx="250" cy="341.91" rx="235.59" ry="136.02" style="fill:#f0f0f0">
            </ellipse>
          </g>
          <g id="freepik--Shadow--inject-4">
            <ellipse id="freepik--shadow--inject-4" cx="201.25" cy="398.08" rx="81.24" ry="46.9" style="fill:#e0e0e0">
            </ellipse>
          </g>
          ...
          <g id="freepik--question-marks--inject-4">
            <g id="freepik--question-marks--inject-4">
              <path
        ...
        <p class="text-white text-center"><span class="text-xl font-bold">Mot de passe oublié</span> <br> Veuilez saisir
          l'email
          associé à votre compte. Un mail vous sera envoyé pour la suite des opérations</p>
      </div>
...
function getMail() {
  ...
  if (!chargement.value) {
    ...
    AuthentificationService.getMail(mail.value).then(response => {
