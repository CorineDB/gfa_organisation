<template>
  ...
  <div
    ...
    :key="index" class="flex flex-col py-2">
    <div class="flex items-center justify-between">
      <!-- Organization Name and Logo -->
      <div class="flex items-center space-x-2">
        <img :src="org.image" alt="Org Logo" class="w-6 h-6 rounded-full" />
        <span class="organization-name font-medium text-sm">{{ org.name }}</span>
      </div>
      <!-- Submission Count -->
    ...
    <div class="mt-2">
      <div class="relative h-1 w-full bg-gray-200 rounded-full" style="height:5px;">
        <div
...
const getBarColor = (percent) => {
  ...
  if (percent < 0.50) return "#C00000"; // Dark Red for 25% to 50%
